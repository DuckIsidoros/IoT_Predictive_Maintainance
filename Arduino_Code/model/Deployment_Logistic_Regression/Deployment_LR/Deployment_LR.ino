...
// Updated for Logistic Regression structure
...
void setup()
{
    Serial.begin(115200);
    delay(2000);
    Serial.println(F("\n--- KHOI DONG HE THONG (LOGISTIC REGRESSION) ---"));
...
// Rewritten optimized Logistic Regression Inference Engine
void predict_logistic_regression(float rx, float ry, float rz, float bLow, float bMid, float bHigh)
{
    ...
    // 2. Compute Raw Logits (Linear Combination: Matrix-Vector Multiplication)
